...
| Плагин | Описание |
|---|---|
| **POUR** | Прототип Root Bear (Playdate): медведь-бармен наливает root beer. Стик ←→ — наклон кувшина (скорость потока), клик — налив/подать кружку. Оценки PERFECT / GOOD / BAD, лучший результат хранится. |
